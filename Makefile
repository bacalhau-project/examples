...
$(DST_DIR)/case-studies/duckdb-log-processing/terraform/Tailscale: $(SRC_DIR)/case-studies/duckdb-log-processing/terraform/Tailscale
	mkdir -p $(@D)
	cp $< $@

convert: init $(DST_FILES) $(DST_IMGS) $(DST_DIR)/case-studies/duckdb-log-processing/terraform/Tailscale
