...
def cleanup_tables():
    ...
    tables_to_keep = {
        "sensor_readings_ingestion": """
            CREATE TABLE IF NOT EXISTS {catalog}.{schema}.sensor_readings_ingestion (
                turbine_id STRING,
                timestamp TIMESTAMP,
                temperature DOUBLE,
                humidity DOUBLE,
        ...
        "sensor_readings_validated": """
            CREATE TABLE IF NOT EXISTS {catalog}.{schema}.sensor_readings_validated (
                turbine_id STRING,
                timestamp TIMESTAMP,
                temperature DOUBLE,
                humidity DOUBLE,
        ...
        "sensor_readings_enriched": """
            CREATE TABLE IF NOT EXISTS {catalog}.{schema}.sensor_readings_enriched (
                turbine_id STRING,
                timestamp TIMESTAMP,
                temperature DOUBLE,
                humidity DOUBLE,
        ...
        "sensor_readings_aggregated": """
            CREATE TABLE IF NOT EXISTS {catalog}.{schema}.sensor_readings_aggregated (
                turbine_id STRING,
                hour TIMESTAMP,
