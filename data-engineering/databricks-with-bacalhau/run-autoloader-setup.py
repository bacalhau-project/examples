...
def main():
    ...
    try:
        ...
        CREATE TABLE IF NOT EXISTS {CATALOG}.{DATABASE}.sensor_data_ingestion (
            sensor_id STRING,
            timestamp TIMESTAMP,
            temperature DOUBLE,
            humidity DOUBLE,
        ...
        console.print(f"  Table: sensor_data_ingestion")
        ...
        console.print("\n2. Query results:")
        console.print(f"   SELECT COUNT(*) FROM {CATALOG}.{DATABASE}.sensor_data_ingestion")
