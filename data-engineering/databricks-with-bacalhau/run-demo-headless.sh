...
FROM expanso-databricks-workspace.sensor_data.sensor_data_ingestion
...
echo "2. Query results: cd scripts && uv run -s run-databricks-sql.py -q 'SELECT * FROM sensor_data_ingestion LIMIT 10'"
