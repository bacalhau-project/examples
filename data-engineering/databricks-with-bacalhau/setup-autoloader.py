    ...
    autoloader_configs = [
        {
            ...
            "target_table": "sensor_data_ingestion",
            "sql": """
                -- Read JSON files and explode the records array
                INSERT INTO {catalog}.{schema}.sensor_data_ingestion
                SELECT 
        ...
        },
        {
            ...
            "target_table": "sensor_data_validated",
            "sql": """
                -- Read JSON files and explode the records array
                INSERT INTO {catalog}.{schema}.sensor_data_validated
                SELECT 
                    record.sensor_id as turbine_id,
                    to_timestamp(record.timestamp) as timestamp,
                    CAST(record.temperature AS DOUBLE) as temperature,
        ...
        },
        {
            ...
            "target_table": "sensor_data_enriched",
            "sql": """
                -- Read JSON files and explode the records array
                INSERT INTO {catalog}.{schema}.sensor_data_enriched
                SELECT 
                    record.sensor_id as turbine_id,
                    to_timestamp(record.timestamp) as timestamp,
                    CAST(record.temperature AS DOUBLE) as temperature,
