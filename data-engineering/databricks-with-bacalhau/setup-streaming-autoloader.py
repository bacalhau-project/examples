...
target_table = f"{{catalog}}.{{schema_name}}.sensor_data_ingestion"
...
target_table = f"{{catalog}}.{{schema_name}}.sensor_data_enriched"
...
target_table = f"{{catalog}}.{{schema_name}}.sensor_data_validated"
...
target_table = f"{{catalog}}.{{schema_name}}.sensor_data_aggregated"
...
target_table = f"{{catalog}}.{{schema_name}}.sensor_data_emergency"
