...
REGISTRY_NAME="${REGISTRY_NAME:-ghcr.io}"
...
# Fail if ORGANIZATION_NAME is not set
if [ -z "${ORGANIZATION_NAME:-}" ]; then
    error "ORGANIZATION_NAME is not set"
fi

# Fail if IMAGE_NAME is not set
...
show_help() {
    ...
    echo
    echo "Options:"
    echo "  -o, --organization  Organization name (default: $ORGANIZATION_NAME)"
