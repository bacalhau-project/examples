...
import (
	...
	wasmhttp "github.com/bacalhau-project/bacalhau/pkg/executor/wasm/funcs/http"
...
func (s *HTTPIntegrationSuite) runTestCase(tc testCase) {
	...
	if params.Network != nil && params.Network.Type != models.NetworkNone {
		err = wasmhttp.InstantiateModule(s.ctx, runtime, params)
...
func defaultParams() wasmhttp.Params {
	return wasmhttp.Params{
