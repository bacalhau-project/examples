...
def close_ports():
    authenticate()
    success, message = run_shell_script("/home/bacalhau-runner/disable-network.sh")
...
def open_ports():
    authenticate()
    success, message = run_shell_script("/home/bacalhau-runner/enable-network.sh")
    return jsonify({"status": "success" if success else "error", "message": message})

@app.route("/close-nfs", methods=["POST"])
def close_nfs():
    authenticate()
    success, message = run_shell_script("/home/bacalhau-runner/disable-nfs.sh")
    return jsonify({"status": "success" if success else "error", "message": message})
...
def open_nfs():
    authenticate()
    success, message = run_shell_script("/home/bacalhau-runner/enable-nfs.sh")
    return jsonify({"status": "success" if success else "error", "message": message})
